...
/*
Package go_micro_srv_AdminLogin is a generated protocol buffer package.
...
type ExampleService interface {
	AdminLogin(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error)
...
func (c *exampleService) AdminLogin(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "Example.AdminLogin", in)
	out := new(Response)
...
type ExampleHandler interface {
	AdminLogin(context.Context, *Request, *Response) error
...
func RegisterExampleHandler(s server.Server, hdlr ExampleHandler, opts ...server.HandlerOption) error {
	type example interface {
		AdminLogin(ctx context.Context, in *Request, out *Response) error
...
func (h *exampleHandler) AdminLogin(ctx context.Context, in *Request, out *Response) error {
	return h.ExampleHandler.AdminLogin(ctx, in, out)
}
